...
#' @description
#' A s4 class that represents the vairables of which the values is a function (of time).
#' The format is
#'   \eqn{f_i(t),\ t\in\Omega=[t_0,t_0 + T]}
#'   where $i$ is the observation (subject) index, $t$ represnets the measurement (time) points.
#'
