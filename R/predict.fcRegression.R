...
#' See arguement FC in \code{\link{fcRegression}}.
#' @param newData.Z A dataframe or a matrix or a atomic vector. See arguement Z in \code{\link{fcRegression}}.
#' @param ... Further arguments passed to or from other methods, including \code{\link[stats]{predict.lm}}, \code{\link[stats]{predict.glm}}, \code{\link[lme4]{predict.merMod}}.
#' @return See \code{\link[stats]{predict.lm}}, \code{\link[stats]{predict.glm}}, \code{\link[lme4]{predict.merMod}}.
#' @export
#' @author Heyang Ji
#' @examples
